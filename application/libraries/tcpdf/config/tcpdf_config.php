 ...
 */
define ('PDF_HEADER_LOGO', 'ut.png');

/**
 * Header logo image width in user units.
 */
define ('PDF_HEADER_LOGO_WIDTH', 80);
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Administración de proyectos tecnológicos');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "por Ing. Callejas - UTEC\nwww.utec.com");
